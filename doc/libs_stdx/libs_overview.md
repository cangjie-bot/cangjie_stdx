...
| [plugin](./plugin/plugin_package_overview.md)                                  | plugin 包提供了编写 AST 插件和 CHIR 插件的能力。                                                                                                                      |
| [plugin.macros](./plugin/plugin_macros_package_overview.md)                    | plugin.macros 包提供了编写 AST 插件和 CHIR 插件的所需要的宏。                                                                                                                      |
