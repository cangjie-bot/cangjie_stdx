...
| import stdx.plugin.*                      | stdx.syntax                                                                                                                                                                                                                    |
| import stdx.plugin.macros.*                      | stdx.plugin、stdx.syntax                                                                                                                                                                                                                    |
...
| [plugin](./plugin/plugin_package_overview.md)                                  | plugin 包为开发者提供了编写 AST 插件和 CHIR 插件的能力。                                                                                                                      |
| [plugin.macros](./plugin/plugin_macros_package_overview.md)                    | plugin.macros 包为开发者提供了编写 AST 插件和 CHIR 插件的所需要的宏。                                                                                                                      |
