...
- decryptCallback: ?[KeylessDecryptFunc](./tls_package_type.md#type-keylesssignfunc) - 解密回调函数，默认为 None\<[KeylessDecryptFunc](./tls_package_type.md#type-keylesssignfunc)>。
