...
```text
trailingClosureExpr.getCommasPos()[0]: 1:11-1:12
trailingClosureExpr.getCommasPos()[1]: 1:18-1:19
```
...
```text
trailingClosureExpr.getLParenPos(): 1:5-1:6
```
...
```text
trailingClosureExpr.getRParenPos(): 1:13-1:14
```
