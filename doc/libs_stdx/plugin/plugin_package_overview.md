...
|                 类名               |                功能                |
| --------------------------------- | ---------------------------------- |
| [ASTPlugin](./plugin_package_api/plugin_package_classes.md#class-astplugin) | 表示 AST 插件的抽象基类，定义了插件的基本接口。 |

### 枚举

|                 枚举名             |                功能                |
| --------------------------------- | ---------------------------------- |
| [CompileStage](./plugin_package_api/plugin_package_enums.md#enum-compilestage) | 表示编译阶段的类型，包括 `BeforeMacro`、`AfterSema`、`CHIR` 等。|
