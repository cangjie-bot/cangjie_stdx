...
Windows 上交叉编译 OpenHarmony 需要使用 DevEco Studio。
DevEco Studio 自带 OpenHarmony 工具链，无需设置上面的环境变量。

> **注意**：
>
> 部分版本 DevEco Studio 可能缺少 openssl 头文件， 构建过程中报错找不到 openssl 头文件，需要准备 openssl 头文件放入 DevEco Studio 的 sysroot 下。 openssl [下载地址](https://slproweb.com/products/Win32OpenSSL.html)
>
