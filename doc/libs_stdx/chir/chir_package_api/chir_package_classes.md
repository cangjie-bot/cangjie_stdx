...
```cangjie
public class BoolType <: Type & Equatable<BoolType>
```
...
```cangjie
public class CPointerType <: Type & Equatable<CPointerType>
```
...
```cangjie
public class CStringType <: Type & Equatable<CStringType>
```
...
```cangjie
public class NothingType <: Type & Equatable<NothingType>
```
...
```cangjie
sealed abstract class NumericType <: Type & Equatable<NumericType>
```
...
```cangjie
public class RuneType <: Type & Equatable<RuneType>
```
...
```cangjie
public class UnitType <: Type & Equatable<UnitType>
```
