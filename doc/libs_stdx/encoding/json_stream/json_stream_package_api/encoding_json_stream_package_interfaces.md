...
main() {
    ...
    let originalConcurrentHashMap: HashMap<String, Int64> = HashMap<String, Int64>()
    ...
    let concurrentHashMapValue: HashMap<String, Int64> = HashMap.fromJson(reader)

    println("ConcurrentHashMap反序列化结果: ${concurrentHashMapValue}")
}
```
...
```text
ConcurrentHashMap反序列化结果: [(key1, 10), (key2, 20), (key3, 30)]
```
