...
```text
JsonArray 内容: [null,true,100,{"hello":"world"}]
数量: 4
...
main() {
    ...
    println("索引 2 的值: ${element1}")

    let element3 = jsonArray[3]
    println("索引 4 的值: ${element3}")
...
main() {
    ...
    println("JsonObject转换为JSON字符串: ${jsonStr}")
}
```
...
main() {
    ...
    println("默认格式的JSON字符串: ${jsonStr1}")
    println("指定参数的JSON字符串: ${jsonStr2}")
}
```
...
main() {
    ...
    println("不转义的默认格式JSON字符串: ${jsonStr1}")
    println("不转义的指定参数JSON字符串: ${jsonStr2}")
}
```
...
main() {
    ...
    println("JsonValue转换为JSON字符串: ${jsonStr}")
}
```
