...
> **Note**:
>
> Some versions of DevEco Studio may lack openssl header files. If the build process reports an error stating that openssl header files cannot be found, developers need to prepare the openssl header files and place them in the sysroot of DevEco Studio. openssl [Download Link](https://slproweb.com/products/Win32OpenSSL.html)
>
