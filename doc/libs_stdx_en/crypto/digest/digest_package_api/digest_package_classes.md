...
Function: Provides the implementation interface for the [MD5](digest_package_classes.md#class-md5) algorithm. For usage examples, see [MD5 Algorithm Example](../digest_samples/sample_digest.md#MD5-算法示例).
...
Function: Provides the implementation interface for the [SHA1](digest_package_classes.md#class-sha1) algorithm. For usage examples, see [SHA1 Algorithm Example](../digest_samples/sample_digest.md#SHA1-算法示例).
...
Function: Provides the implementation interface for the [SHA224](digest_package_classes.md#class-sha224) algorithm. Usage examples can be found in [SHA224 Algorithm Example](../digest_samples/sample_digest.md#SHA224-算法示例).
...
Function: Provides the implementation interface for the [SHA256](digest_package_classes.md#class-sha256) algorithm. Usage examples can be found in [SHA256 Algorithm Example](../digest_samples/sample_digest.md#SHA256-算法示例).
...
Function: Provides the implementation interface for the [SHA384](digest_package_classes.md#class-sha384) algorithm. Usage examples can be found in [SHA384 Algorithm Example](../digest_samples/sample_digest.md#SHA384-算法示例).Parent Type:
