...
| ------------------------------------- | ----------------------------------------- |
| [CompileStage](./plugin_package_api/plugin_package_enums.md#enum-compilestage) | Represents the compilation stage type, including `BeforeMacro`, `AfterSema`, `CHIR`, etc. |
