...
string(TOLOWER ${TARGET_TRIPLE_DIRECTORY_PREFIX}_cjnative output_cj_lib_dir)

# 先查找库文件
find_library(AS_SUPPORT_LIB
    NAMES cangjie-ast-support
    PATHS $ENV{CANGJIE_HOME}/lib/${output_cj_lib_dir}/
    NO_DEFAULT_PATH
)

# 如果找不到，直接报错
if(NOT AS_SUPPORT_LIB)
    message(FATAL_ERROR "Could not find cangjie-ast-support library at $ENV{CANGJIE_HOME}/lib/${output_cj_lib_dir}/")
endif()
...
make_cangjie_lib(
    ...
    FLAGS 
        -L$ENV{CANGJIE_HOME}/lib/${output_cj_lib_dir}
        -lcangjie-std-astFFI
        $<TARGET_OBJECTS:stdx.syntaxFFI-objs>
        $<$<NOT:$<BOOL:${WIN32}>>:-ldl>
    )
