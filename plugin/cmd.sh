...
cjc ../src/stdx/CHIR/lib/*.cj --output-type=dylib -g -Woff all -o libCHIR.lib.so

echo "start to build CHIR serialize ..."
cjc ../src/stdx/CHIR/serialize/*.cj --output-type=dylib -g -Woff all -L . -lCHIR.lib -o libCHIR.serialize.so
...
cjc ../src/stdx/plugin/register/*.cj --compile-macro -g -L . -lplugin -Woff all

echo "start to build plugin execute ..."
cjc ../src/stdx/plugin/execute/*.cj --output-type=dylib -g -Woff all -L . -lCHIR.serialize -lplugin -o libplugin.execute.so
