...
# Apple ld64
cjc -L $STATIC_OPENSSL_DIR --link-option --link-option "-force_load" --link-option "$STATIC_OPENSSL_DIR/libssl.a" --link-option "-force_load" --link-option "$STATIC_OPENSSL_DIR/libcrypto.a" main.cj
```
