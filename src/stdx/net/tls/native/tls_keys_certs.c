...
static EVP_PKEY* keyless_from_rsa_pubkey(EVP_PKEY* pub, const char* keyId, DynMsg* dynMsg)
{
...
static EVP_PKEY* keyless_from_ec_pubkey(EVP_PKEY* pub, const char* keyId, DynMsg* dynMsg)
{
...
static EVP_PKEY* MakeKeylessFromPubkey(EVP_PKEY* pub, const char* keyId, DynMsg* dynMsg)
{
    ...
    if (type == EVP_PKEY_RSA) {
        return keyless_from_rsa_pubkey(pub, keyId, dynMsg);
    }
    if (type == EVP_PKEY_EC) {
        return keyless_from_ec_pubkey(pub, keyId, dynMsg);
    }
