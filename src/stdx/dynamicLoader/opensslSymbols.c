 ...
 */
#if defined(CANGJIE_OPENSSL_RESOLVE_AUTO) && (defined(__GNUC__) || defined(__clang__))
#define CANGJIE_OPENSSL_AUTO_WEAK_AVAILABLE 1
#define CANGJIE_DO_PRAGMA(x) _Pragma(#x)
#if defined(__APPLE__)
#define CANGJIE_PRAGMA_WEAK(sym) extern __typeof__(sym) sym __attribute__((weak_import));
#else
