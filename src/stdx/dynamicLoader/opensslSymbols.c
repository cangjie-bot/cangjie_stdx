...
#define CANGJIE_OPENSSL_TRY_WEAK(func, name) func = (SSLFunc##index)(name)
#else
#define CANGJIE_OPENSSL_TRY_WEAK(func, name) do { } while (0)
#endif
#define FINDFUNCTIONI(dynMsg, index, name, errCode)                                                                                                                                \
    static SSLFunc##index func##index = NULL;                                                                                                                                      \
    if (func##index == NULL) {                                                                                                                                                     \
        CANGJIE_OPENSSL_TRY_WEAK(func##index, name);                                                                                                                               \
        if (func##index == NULL) {                                                                                                                                                 \
            func##index = (SSLFunc##index)(FindFunction(#name));                                                                                                                   \
        }                                                                                                                                                                          \
    }                                                                                                                                                                              \
    CHECKFUNCTION(dynMsg, index, #name, errCode)
#undef CANGJIE_OPENSSL_TRY_WEAK
#else
#define FINDFUNCTIONI(dynMsg, index, name, errCode)                                                                                                                                \
    static SSLFunc##index func##index = NULL;                                                                                                                                      \
    if (func##index == NULL) {                                                                                                                                                     \
